...
view.steps = [
  ...
  require('./steps/16_cool.json'),
  require('./steps/17_fermenter_out.json'),
  require('./steps/18_cip_water_coil.json'),
  require('./steps/19_cip_water_cfc.json'),
  require('./steps/20_cip_water_mt.json'),
  require('./steps/21_cip_water_bk.json'),
