...
const nodeRecurser = (parent: string[], key: string, val: string | any) => {
...
export const nodeBuilder = (fields: { [measurement: string]: string[] }) => {
...
export const targetSplitter = (targets: QueryTarget[]): string[] =>
  targets
    .reduce(
...
export const targetBuilder = (vals: string[]): QueryTarget[] =>
  vals
    .reduce(
