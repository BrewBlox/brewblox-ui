...
export interface CrudPluginProps {
  crud: {
    type: PropType<Crud>,
    required: true,
  }
...
export type CrudPluginEmits = string[];

export interface CrudPluginComponent<ConfigT> {
  crud: Crud<ConfigT>;
...
interface UseCrudComposable {
  <ConfigT>(crud: Crud<ConfigT>): CrudPluginComponent<ConfigT>;
  props: CrudPluginProps;
  emits: CrudPluginEmits;
}

const props: CrudPluginProps = {
  crud: {
...
const emits: CrudPluginEmits = [];

function compose<ConfigT>(crud: Crud<ConfigT>): CrudPluginComponent<ConfigT> {
...
export const useCrud: UseCrudComposable = compose;
