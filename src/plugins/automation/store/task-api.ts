...
export const fetchAll = (): Promise<AutomationTask[]> =>
  http
    .get<AutomationTask[]>('/automation/task/all')
    .then((resp) => resp.data)
...
export const remove = ({
  ...
  http
    .delete(`/automation/task/delete/${id}`)
    .then(() => {})
