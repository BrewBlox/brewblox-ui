...
<template>
  <g :transform="`scale(${scale} ${scale})`">
    ...
    <g class="outline legs">
      ...
      <path
        d="M67,370v11.9l5.3,5.1H80v4h-9.4l-3.6-3.4v9.6c2-1.6,4.7-2.5,7.5-2.5s5.5,0.9,7.5,2.5V370H67z"
      />
      ...
      <path
        d="M65.2,344c0,0.7,0.7,1.3,1.8,1.7c-0.3,0.4-0.4,0.9-0.4,1.3c0,0.5,0.1,0.9,0.4,1.3c-1.1,0.4-1.8,1-1.8,1.7
        c0,1.1,1.8,2,4,2c1.4,0,2.6-0.4,3.4-0.9c0.8,0.1,1.7,0.2,2.6,0.2s1.8-0.1,2.6-0.2c0.7,0.5,1.9,0.9,3.4,0.9
        c2.2,0,4-0.9,4-2c0-0.7-0.7-1.3-1.8-1.7c0.3-0.4,0.4-0.9,0.4-1.3c0-0.5-0.1-0.9-0.4-1.3c1.1-0.4,1.8-1,1.8-1.7
        l-0.1-12c0-1.1-1.8-1.9-4-1.9c-1.4,0-2.6,0.4-3.3,0.9c-0.8-0.1-1.7-0.2-2.6-0.2s-1.8,0.1-2.6,0.2
        c-0.7-0.5-2-0.9-3.4-0.9c-3.2,0-4,1.6-4,1.6V344z"
      />
      <ellipse cx="75" cy="347.2" rx="4" ry="2" />
      <circle cx="74.8" cy="407.2" r="12.5" />
      <path
        d="M83.3,409.8c0.3-0.8,0.4-1.7,0.4-2.6s-0.1-1.8-0.4-2.6c1.1-0.7,1.8-1.9,1.8-3.4c0-2.2-1.8-4-4-4
        c-1.4,0-2.6,0.7-3.4,1.8c-0.8-0.3-1.7-0.4-2.6-0.4s-1.8,0.1-2.6,0.4c-0.7-1.1-1.9-1.8-3.4-1.8
        c-2.2,0-4,1.8-4,4c0,1.4,0.7,2.6,1.8,3.4c-0.3,0.8-0.4,1.7-0.4,2.6s0.1,1.8,0.4,2.6
        c-1.1,0.7-1.8,1.9-1.8,3.4c0,2.2,1.8,4,4,4c1.4,0,2.6-0.7,3.4-1.8c0.8,0.3,1.7,0.4,2.6,0.4
        s1.8-0.1,2.6-0.4c0.7,1.1,1.9,1.8,3.4,1.8c2.2,0,4-1.8,4-4C85.1,411.8,84.4,410.5,83.3,409.8z"
      />
