...
export default defineComponent({
  ...
  setup(props, { emit }) {
    const chosenNames = reactive<Partial<FridgeConfigNames>>({});
    ...
    const names = computed<FridgeConfigNames>(
      () => ({
        ...mapValues(
          defaultNames,
    ...
    function clearKey(key: keyof FridgeConfig): void {
...
<template>
  <ActionCardBody>
    <q-card-section>
      ...
      <!-- Block names -->
      <q-expansion-item
        label="Block names (click to expand)"
