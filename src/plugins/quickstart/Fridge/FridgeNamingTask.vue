...
@Component
export default class FridgeNamingTask extends QuickStartTaskBase<FridgeConfig> {
  chosenNames: Partial<FridgeConfigNames> = {};
  idGenerator = new UrlSafeString();

  get defaultNames(): FridgeConfigNames {
    return {
      fridgeSensor: 'Sensor',
  ...
  get prefix(): string {
    return this.config.prefix ?? 'Fridge';
  }
  ...
  get dashboardTitle(): string {
    return this.config.dashboardTitle ?? 'Fridge';
  }
