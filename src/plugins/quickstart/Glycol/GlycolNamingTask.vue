...
export default defineComponent({
  ...
  setup(props, { emit }) {
    const chosenNames = reactive<Partial<GlycolBlockNames>>({});
    ...
    function updateConfig(cfg: Partial<GlycolConfig>): void {
    ...
    const names = computed<GlycolBlockNames>(
      () => ({
        ...mapValues(
          defaultNames,
    ...
    function clearKey(key: keyof GlycolConfig): void {
