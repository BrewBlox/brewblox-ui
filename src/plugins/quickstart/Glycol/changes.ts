  ...
  const blocks: [
    ...
    PidBlock,
      ...
      // Mutex
      {
        ...
        groups,
        data: {
          differentActuatorWait: bloxQty(5, 'min'),
      ...
      PidBlock
        ...
        // Digital actuator
        {
          ...
          data: {
            ...
            constrainedBy: {
              constraints: [
                { minOff: bloxQty('5min'), remaining: bloxQty('0s') },
                { minOn: bloxQty('3min'), remaining: bloxQty('0s') },
              ],
            },
          },
        },
        ...
        },
        {
          ...
          changes: [
            ...
            },
            {
              ...
              data: {
                settingEnabled: true,
                storedSetting: bloxQty(20.0, 'degC').to(userTemp),
              },
              confirmed: {
                storedSetting: true,
              },
