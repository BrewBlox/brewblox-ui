    ...
    <q-card-section>
      <q-item dark class="align-children">
        ...
        <q-item-section>
          ...
          <div v-if="mutexClients.idle.length === 0">--</div>
        </q-item-section>
      </q-item>
    </q-card-section>
  </q-card>
