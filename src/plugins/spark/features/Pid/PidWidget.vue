        ...
        <div :class="orientationClass">
          <q-card-main class="column col">
            ...
            <q-field class="col" label="Target">
              <big>{{ block.data.inputSetting ? block.data.inputSetting : '-' | unit }}</big>
            </q-field>
            <q-field class="col" label="Actual">
              <big>{{ block.data.inputValue ? block.data.inputValue : '-' | unit }}</big>
            </q-field>
          </q-card-main>
          <q-card-main class="column col">
            <q-item class="full-width text-center">Output</q-item>
            <q-field class="col" label="Target">
              <big>{{ block.data.outputSetting ? block.data.outputSetting : '-' | unit }}</big>
            </q-field>
            <q-field class="col" label="Actual">
              <big>{{ block.data.outputValue ? block.data.outputValue : '-' | unit }}</big>
            </q-field>
          </q-card-main>
        </div>
      </q-carousel-slide>
