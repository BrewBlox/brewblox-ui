...
import { FlowSegment } from '@/plugins/schema/FlowSegment';
import {
  asFlowParts,
  calculateFlows,
  flowPath,
  partTransitions,
} from '@/plugins/schema/calculateFlows';
import { COLD_WATER, HOT_WATER, IN_OUT } from '@/plugins/schema/getters';
import { StatePart } from '@/plugins/schema/types';
